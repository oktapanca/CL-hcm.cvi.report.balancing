		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Report Balancing",
									"targetURL": "#hcmcvireportbalancing-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hcmcvireportbalancing-display": {
								"semanticObject": "hcmcvireportbalancing",
								"action": "display",
								"description": "Report Balancing",
								"title": "Report Balancing",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hcm.cvi.report.balancing",
									"url": sap.ui.require.toUrl("hcm/cvi/report/balancing")
								}
							}
						}
					}
