sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("hcm.cvi.report.balancing.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias hcm.cvi.report.balancing.controller.ListSelector
			 */
			 ...
			 * @return {hcm.cvi.report.balancing.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
